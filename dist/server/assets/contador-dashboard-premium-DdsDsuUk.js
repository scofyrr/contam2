...
import { aq as usePermissions, as as useSession } from "./router-B2fOVgbK.js";
...
import { c as contadorDashboardService, f as formatSoles } from "./use-admin-metrics-DcSELLQl.js";
...
const WIDGET_REGISTRY = {
  kpis: {
    component: reactExports.lazy(() => import("./kpi-cards-widget-Qz-64XN0.js")),
  ...
  tareas_urgentes: {
    component: reactExports.lazy(() => import("./tareas-urgentes-widget-DLUgn_2a.js")),
  ...
  clientes: {
    component: reactExports.lazy(() => import("./clientes-grafico-widget-DIt_O4ft.js")),
    nombre: "Mis Clientes",
  ...
  carga_trabajo: {
    component: reactExports.lazy(() => import("./carga-trabajo-widget-DGwz7BCj.js")),
  ...
  sugerencias: {
    component: reactExports.lazy(() => import("./sugerencias-widget-glJ3NWMP.js")),
  ...
  logros: {
    component: reactExports.lazy(() => import("./logros-widget-C8o1-xml.js")),
  ...
  actividad_reciente: {
    component: reactExports.lazy(() => import("./actividad-reciente-widget-CcorniKM.js")),
  ...
  meta_mensual: {
    component: reactExports.lazy(() => import("./meta-mensual-widget-gf42f7PV.js")),
    nombre: "Meta Mensual",
  ...
  proximos_vencimientos: {
    component: reactExports.lazy(() => import("./proximos-vencimientos-widget-YORJPHx9.js")),
  ...
  enlaces_rapidos: {
    component: reactExports.lazy(() => import("./enlaces-rapidos-widget-Bor4mDqe.js")),
