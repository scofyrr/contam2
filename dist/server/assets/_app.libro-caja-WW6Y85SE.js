...
import { ar as useQueryClient, aj as toast, V as normalizeCuentaContable, ai as toAsientoContableInsert, ac as supabase, O as logSupabaseAsientosInsertError, a7 as round2, C as CUENTAS_DEFAULT, A as ASIENTOS_CONTABLES_SELECT, e as Route } from "./router-CQNpPKTf.js";
...
import { q as queryKeys, u as upsertCuentaFinanciera, d as desactivarCuentaFinanciera, f as fetchCuentasFinancieras, i as invalidateLibrosContables, M as MEDIOS_PAGO_SUNAT, E as EmpresaPeriodoFilters, R as RequireRucEmptyState } from "./cuentas-financieras-types-CfcAWLT4.js";
...
import { r as revertirCancelacion } from "./asiento-cancelacion-XeIcRgjx.js";
...
import { ejecutarCentralizarPeriodo, createMovimientoCaja, fetchMovimientosCaja, updateMovimientoCaja, fetchMovimientosSinCentralizar } from "./caja-service-Bukej9I-.js";
import { u as useDjangoApi } from "./http-client-BAKcXjQw.js";
...
import { T as TrendingUp } from "./trending-up-JMPGpX1r.js";
import { T as TrendingDown } from "./trending-down-BLjRsFkz.js";
import { R as ResponsiveContainer } from "./generateCategoricalChart-CUeTZzKU.js";
import { L as LineChart } from "./LineChart-CzPUSD7_.js";
import { L as Line } from "./Line-D_re0xjE.js";
import { D as Dialog, a as DialogContent, d as DialogHeader, e as DialogTitle, c as DialogFooter } from "./dialog-Dc200DvG.js";
...
import { C as Check } from "./Combination-0mr5ceEx.js";
import { X } from "./x-PTE7pfQq.js";
...
async function buildLiquidezFallback(ruc) {
  const { fetchMovimientosCaja: fetchMovimientosCaja2 } = await import("./caja-service-Bukej9I-.js");
  const { fetchCuentasFinancieras: fetchCuentasFinancieras2 } = await import("./cuentas-financieras-types-CfcAWLT4.js").then((n) => n.c);
  if (ruc?.trim()) {
