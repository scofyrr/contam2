...
import { ar as useQueryClient, aj as toast, V as normalizeCuentaContable, ai as toAsientoContableInsert, ac as supabase, O as logSupabaseAsientosInsertError, a7 as round2, C as CUENTAS_DEFAULT, A as ASIENTOS_CONTABLES_SELECT, e as Route } from "./router-BRL0s0LD.js";
...
import { q as queryKeys, u as upsertCuentaFinanciera, d as desactivarCuentaFinanciera, f as fetchCuentasFinancieras, i as invalidateLibrosContables, M as MEDIOS_PAGO_SUNAT, E as EmpresaPeriodoFilters, R as RequireRucEmptyState } from "./cuentas-financieras-types-tDhgjIqG.js";
...
import { A as AlertDialog, h as AlertDialogTrigger, c as AlertDialogContent, f as AlertDialogHeader, g as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, b as AlertDialogCancel, a as AlertDialogAction } from "./alert-dialog-CMA3WmXa.js";
import { r as revertirCancelacion } from "./asiento-cancelacion-BpJ13Bhd.js";
...
import { ejecutarCentralizarPeriodo, createMovimientoCaja, fetchMovimientosCaja, updateMovimientoCaja, fetchMovimientosSinCentralizar } from "./caja-service-CQXY-TU0.js";
import { u as useDjangoApi } from "./http-client-BNGDvc7A.js";
...
import { T as TrendingDown } from "./trending-down-C3E-7TSV.js";
import { R as ResponsiveContainer } from "./generateCategoricalChart-BQLb8jz6.js";
import { L as LineChart } from "./LineChart-BfqMp68i.js";
import { L as Line } from "./Line-S-B0SzCb.js";
import { D as Dialog, a as DialogContent, d as DialogHeader, e as DialogTitle, c as DialogFooter } from "./dialog-Cnq_krfY.js";
...
async function buildLiquidezFallback(ruc) {
  const { fetchMovimientosCaja: fetchMovimientosCaja2 } = await import("./caja-service-CQXY-TU0.js");
  const { fetchCuentasFinancieras: fetchCuentasFinancieras2 } = await import("./cuentas-financieras-types-tDhgjIqG.js").then((n) => n.c);
  if (ruc?.trim()) {
