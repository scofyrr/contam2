...
import { ap as usePermissions, ar as useSession } from "./router-DdOnzL1Y.js";
...
import { c as contadorDashboardService, f as formatSoles } from "./use-admin-metrics-Bi0FrkKI.js";
...
const WIDGET_REGISTRY = {
  kpis: {
    component: reactExports.lazy(() => import("./kpi-cards-widget-v0ewn_x-.js")),
  ...
  tareas_urgentes: {
    component: reactExports.lazy(() => import("./tareas-urgentes-widget-CUMg9xjY.js")),
  ...
  clientes: {
    component: reactExports.lazy(() => import("./clientes-grafico-widget-CvCrBYdk.js")),
    nombre: "Mis Clientes",
  ...
  carga_trabajo: {
    component: reactExports.lazy(() => import("./carga-trabajo-widget-BTVKZY8X.js")),
  ...
  sugerencias: {
    component: reactExports.lazy(() => import("./sugerencias-widget-YDmc5bDR.js")),
  ...
  logros: {
    component: reactExports.lazy(() => import("./logros-widget-nkvTASRj.js")),
  ...
  actividad_reciente: {
    component: reactExports.lazy(() => import("./actividad-reciente-widget-0WGHBtda.js")),
  ...
  meta_mensual: {
    component: reactExports.lazy(() => import("./meta-mensual-widget-BHltlyFR.js")),
    nombre: "Meta Mensual",
  ...
  proximos_vencimientos: {
    component: reactExports.lazy(() => import("./proximos-vencimientos-widget-NMbAhANQ.js")),
  ...
  enlaces_rapidos: {
    component: reactExports.lazy(() => import("./enlaces-rapidos-widget-BQRAtkhO.js")),
