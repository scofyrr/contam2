...
import { c as Route } from "./router-BRL0s0LD.js";
import "node:async_hooks";
import "node:stream/web";
import "node:stream";
import "./utils-8RO4xBwZ.js";
const SireDashboardHub = reactExports.lazy(() => import("./SireDashboardHub-BROL2ch7.js").then((m) => ({
  default: m.SireDashboardHub
})));
const SireSyncDashboardPremium = reactExports.lazy(() => import("./sire-sync-dashboard-premium-F3xnepL3.js"));
