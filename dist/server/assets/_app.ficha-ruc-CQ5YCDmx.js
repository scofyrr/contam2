...
import { a as aiFieldAttrs, c as applyFillToFicha, d as buildFichaFieldSnapshots, e as useRegisterAiComposerPage } from "./ai-composer-fill-Buh6mI6A.js";
...
import { ac as supabase, u as fetchRegistrosSireRows, ar as useQueryClient, aj as toast, an as useNavigate, f as Route } from "./router-B2fOVgbK.js";
...
import { fetchMovimientosCaja } from "./caja-service-DoK5iLHO.js";
...
async function exportFichaPdf(ficha) {
  const {
    jsPDF
  } = await import("./jspdf.es.min-W2W0Fm1x.js").then((n) => n.j);
