...
import { a as aiFieldAttrs, c as applyFillToFicha, d as buildFichaFieldSnapshots, e as useRegisterAiComposerPage } from "./ai-composer-fill-fiOE1kMU.js";
...
import { ab as supabase, u as fetchRegistrosSireRows, aq as useQueryClient, ai as toast, am as useNavigate, f as Route } from "./router-B2oVQHub.js";
...
import { fetchMovimientosCaja } from "./caja-service-Camm94UV.js";
...
import { U as User } from "./user-ybrHQhP7.js";
...
async function exportFichaPdf(ficha) {
  const {
    jsPDF
  } = await import("./jspdf.es.min-BHyzubRe.js").then((n) => n.j);
