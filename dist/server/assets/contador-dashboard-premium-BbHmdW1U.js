...
import { b as useEstudioConfig } from "./use-estudio-config-D8B-OB3s.js";
import { aq as usePermissions, as as useSession } from "./router-CQNpPKTf.js";
...
import { c as contadorDashboardService, f as formatSoles } from "./use-admin-metrics-Cv5Qxi1L.js";
...
const WIDGET_REGISTRY = {
  kpis: {
    component: reactExports.lazy(() => import("./kpi-cards-widget-5MD4BfXv.js")),
  ...
  tareas_urgentes: {
    component: reactExports.lazy(() => import("./tareas-urgentes-widget-Bk5rAFSP.js")),
  ...
  clientes: {
    component: reactExports.lazy(() => import("./clientes-grafico-widget-DvVxBrfs.js")),
    nombre: "Mis Clientes",
  ...
  carga_trabajo: {
    component: reactExports.lazy(() => import("./carga-trabajo-widget-B17YPUY6.js")),
  ...
  sugerencias: {
    component: reactExports.lazy(() => import("./sugerencias-widget-Hc1tfRgF.js")),
  ...
  logros: {
    component: reactExports.lazy(() => import("./logros-widget-CsubRJG0.js")),
  ...
  actividad_reciente: {
    component: reactExports.lazy(() => import("./actividad-reciente-widget-Cuf5Kxzz.js")),
  ...
  meta_mensual: {
    component: reactExports.lazy(() => import("./meta-mensual-widget-CNopYHlP.js")),
    nombre: "Meta Mensual",
  ...
  proximos_vencimientos: {
    component: reactExports.lazy(() => import("./proximos-vencimientos-widget-CG5SzTdE.js")),
  ...
  enlaces_rapidos: {
    component: reactExports.lazy(() => import("./enlaces-rapidos-widget-DTVAzc6k.js")),
