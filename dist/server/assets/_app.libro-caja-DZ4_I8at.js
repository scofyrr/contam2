...
import { ar as useQueryClient, aj as toast, V as normalizeCuentaContable, ai as toAsientoContableInsert, ac as supabase, O as logSupabaseAsientosInsertError, a7 as round2, C as CUENTAS_DEFAULT, A as ASIENTOS_CONTABLES_SELECT, e as Route } from "./router-B2fOVgbK.js";
...
import { q as queryKeys, u as upsertCuentaFinanciera, d as desactivarCuentaFinanciera, f as fetchCuentasFinancieras, i as invalidateLibrosContables, M as MEDIOS_PAGO_SUNAT, E as EmpresaPeriodoFilters, R as RequireRucEmptyState } from "./cuentas-financieras-types-38DFugCH.js";
...
import { A as AlertDialog, h as AlertDialogTrigger, c as AlertDialogContent, f as AlertDialogHeader, g as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, b as AlertDialogCancel, a as AlertDialogAction } from "./alert-dialog-Ccl4iijL.js";
import { r as revertirCancelacion } from "./asiento-cancelacion-CNl2nOQQ.js";
...
import { ejecutarCentralizarPeriodo, createMovimientoCaja, fetchMovimientosCaja, updateMovimientoCaja, fetchMovimientosSinCentralizar } from "./caja-service-DoK5iLHO.js";
import { u as useDjangoApi } from "./http-client-B_ATtUrg.js";
import { E as Eye } from "./eye-C4ug0RW_.js";
import { R as RotateCcw } from "./rotate-ccw-BqqJqpKS.js";
...
async function buildLiquidezFallback(ruc) {
  const { fetchMovimientosCaja: fetchMovimientosCaja2 } = await import("./caja-service-DoK5iLHO.js");
  const { fetchCuentasFinancieras: fetchCuentasFinancieras2 } = await import("./cuentas-financieras-types-38DFugCH.js").then((n) => n.c);
  if (ruc?.trim()) {
