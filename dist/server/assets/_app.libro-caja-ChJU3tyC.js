...
import { ar as useQueryClient, aj as toast, V as normalizeCuentaContable, ai as toAsientoContableInsert, ac as supabase, O as logSupabaseAsientosInsertError, a7 as round2, C as CUENTAS_DEFAULT, A as ASIENTOS_CONTABLES_SELECT, e as Route } from "./router-CrYSg7RR.js";
...
import { q as queryKeys, u as upsertCuentaFinanciera, d as desactivarCuentaFinanciera, f as fetchCuentasFinancieras, i as invalidateLibrosContables, M as MEDIOS_PAGO_SUNAT, E as EmpresaPeriodoFilters, R as RequireRucEmptyState } from "./cuentas-financieras-types-B0G92r3P.js";
...
import { A as AlertDialog, h as AlertDialogTrigger, c as AlertDialogContent, f as AlertDialogHeader, g as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, b as AlertDialogCancel, a as AlertDialogAction } from "./alert-dialog-DTQPqdA6.js";
import { r as revertirCancelacion } from "./asiento-cancelacion-DZJhUysn.js";
...
import { ejecutarCentralizarPeriodo, createMovimientoCaja, fetchMovimientosCaja, updateMovimientoCaja, fetchMovimientosSinCentralizar } from "./caja-service-3ccPmFvB.js";
import { u as useDjangoApi } from "./http-client-i97I_bRM.js";
import { E as Eye } from "./eye-C4t7LTZP.js";
import { R as RotateCcw } from "./rotate-ccw-c9rVR5lt.js";
import { a as cn } from "./utils-8RO4xBwZ.js";
import { W as Wallet } from "./wallet-D2Fh-mBW.js";
import { T as TrendingUp } from "./trending-up-BeTy1HU5.js";
import { T as TrendingDown } from "./trending-down-CXAeYcRI.js";
import { R as ResponsiveContainer } from "./generateCategoricalChart-BOTMLdl4.js";
import { L as LineChart } from "./LineChart-BSemTLnf.js";
...
async function buildLiquidezFallback(ruc) {
  const { fetchMovimientosCaja: fetchMovimientosCaja2 } = await import("./caja-service-3ccPmFvB.js");
  const { fetchCuentasFinancieras: fetchCuentasFinancieras2 } = await import("./cuentas-financieras-types-B0G92r3P.js").then((n) => n.c);
  if (ruc?.trim()) {
