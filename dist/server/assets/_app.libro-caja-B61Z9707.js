...
import { aq as useQueryClient, ai as toast, U as normalizeCuentaContable, ah as toAsientoContableInsert, ab as supabase, M as logSupabaseAsientosInsertError, a6 as round2, C as CUENTAS_DEFAULT, A as ASIENTOS_CONTABLES_SELECT, e as Route } from "./router-DdOnzL1Y.js";
...
import { q as queryKeys, u as upsertCuentaFinanciera, d as desactivarCuentaFinanciera, f as fetchCuentasFinancieras, i as invalidateLibrosContables, M as MEDIOS_PAGO_SUNAT, E as EmpresaPeriodoFilters, R as RequireRucEmptyState } from "./cuentas-financieras-types-Dme4I7af.js";
...
import { A as AlertDialog, h as AlertDialogTrigger, c as AlertDialogContent, f as AlertDialogHeader, g as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, b as AlertDialogCancel, a as AlertDialogAction } from "./alert-dialog-Bl0Pox7y.js";
import { r as revertirCancelacion } from "./asiento-cancelacion-Dw4VgNBB.js";
...
import { ejecutarCentralizarPeriodo, createMovimientoCaja, fetchMovimientosCaja, updateMovimientoCaja, fetchMovimientosSinCentralizar } from "./caja-service-BJmR-66Y.js";
import { u as useDjangoApi } from "./http-client-h7UKjZ8s.js";
import { E as Eye } from "./eye-DV64Us4N.js";
import { R as RotateCcw } from "./rotate-ccw-BTDLw0ld.js";
import { a as cn } from "./utils-8RO4xBwZ.js";
import { W as Wallet } from "./wallet-C0Zz1AOH.js";
import { T as TrendingUp } from "./trending-up-BOQWNFJ6.js";
import { T as TrendingDown } from "./trending-down-ToZW-fxx.js";
import { R as ResponsiveContainer } from "./generateCategoricalChart-CXYoKBQ-.js";
import { L as LineChart } from "./LineChart-Db-l72yv.js";
import { L as Line } from "./Line-yFhjZWFG.js";
import { D as Dialog, a as DialogContent, d as DialogHeader, e as DialogTitle, c as DialogFooter } from "./dialog-BVSdsycQ.js";
...
import { C as Check } from "./Combination-Cm3gVzC7.js";
...
async function buildLiquidezFallback(ruc) {
  const { fetchMovimientosCaja: fetchMovimientosCaja2 } = await import("./caja-service-BJmR-66Y.js");
  const { fetchCuentasFinancieras: fetchCuentasFinancieras2 } = await import("./cuentas-financieras-types-Dme4I7af.js").then((n) => n.c);
  if (ruc?.trim()) {
