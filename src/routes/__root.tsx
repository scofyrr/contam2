...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CONTAM — Contabilidad SUNAT/SIRE" },
      { property: "og:description", content: "Registra comprobantes, genera asientos y exporta tus libros electrónicos al SIRE." },
