...
const nav = [
  ...
  { to: "/profiling", label: "Profiling RUC", icon: Scale },
  { to: "/importador", label: "Importador", icon: Upload },
  { to: "/compras-ventas", label: "Compras/Ventas", icon: Receipt },
  { to: "/contabilidad", label: "Contabilidad", icon: BookOpen },
  { to: "/libro-mayor", label: "Libro Mayor", icon: BookMarked },
  { to: "/workflow", label: "Flujo Contable", icon: GitBranch },
  { to: "/tesoreria", label: "Tesorería", icon: Wallet },
  { to: "/control-formal", label: "Control Formal", icon: ShieldAlert },
